...
h5open(dir * "/" * model_type* "/" * distribution_type *"/forecast_validation_abm.h5", "w") do file
...
open(dir * "/" * model_type* "/" * distribution_type *"/rmse_validation_abm.tex", "w") do fid
    for line in latex
        write(fid, line * "\n")
    end
end
...
open(dir * "/" * model_type* "/" * distribution_type *"/bias_validation_abm.tex", "w") do fid
    for line in latex
        write(fid, line * "\n")
    end
end
