...
h5open(dir * "/" * model_type* "/" * distribution_type *"/forecast_abmx.h5", "w") do file
...
open(dir * "/" * model_type* "/" * distribution_type *"/rmse_abmx.tex", "w") do fid
    for line in latex
        write(fid, line * "\n")
    end
end
...
open(dir * "/" * model_type* "/" * distribution_type *"/bias_abmx.tex", "w") do fid
    for line in latex
        write(fid, line * "\n")
    end
end
